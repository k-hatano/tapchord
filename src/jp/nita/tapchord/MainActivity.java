...
public class MainActivity extends AbstractSingleMidiActivity implements SensorEventListener  {
	...
	public void onDeviceDetached(UsbDevice usbDevice) {
		Toast.makeText(MainActivity.this, getString(R.string.message_midi_device_detached), Toast.LENGTH_LONG).show();
	}

	@Override
	public void onDeviceAttached(UsbDevice usbDevice) {
		Toast.makeText(MainActivity.this, getString(R.string.message_midi_device_attached), Toast.LENGTH_LONG).show();
	}
